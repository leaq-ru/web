  ...
  head () {
    return {
      ...
      meta: [{
        ...
        hid: 'description',
        name: 'description',
        content: 'База компаний из разных городов от Москвы до Владивостока, из категорий от «Создания и продвижения сайтов» до «Черной и цветной металлургии». Доступно скачивание CSV базы, email и телефонов компаний с учетом фильтров поиска. Попробуйте бесплатно или пользуйтесь без ограничений за 990 руб/мес'
      }]
    }
  }
})
